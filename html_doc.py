...
if __name__ == '__main__':
    ...
    new_body.add_tag('h1', "I created this using python is it cool")
    new_body.add_tag('h3', 'Aggregation')
    ...
    new_docType = DocType()
    new_header = Head('I Created this using Python Aggregation document')
    my_page = HtmlDoc(new_docType, new_header, new_body)


#implementing IO with files 
    with open('D:\\Dheeraj-Python.html', 'w') as test_doc:
        my_page.display(file=test_doc)
